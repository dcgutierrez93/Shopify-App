...
import { FOCUSABLE_SELECTOR, findFirstFocusableNode, focusFirstFocusableNode } from '@shopify/javascript-utilities/focus';
...
import { isSameDay, Months, Weekdays, getWeeksForMonth, getNewRange, isDateBefore, isDateAfter, dateIsSelected, dateIsInRange, getNextDisplayYear, getNextDisplayMonth, getPreviousDisplayYear, getPreviousDisplayMonth } from '@shopify/javascript-utilities/dates';
...
function buildCustomProperties(themeConfig, globalTheming, tokens) {
  ...
  return globalTheming ? customPropertyTransformer(Object.assign(Object.assign({}, colorFactory(UNSTABLE_colors, colorScheme)), tokens)) : buildLegacyColors(themeConfig);
}
