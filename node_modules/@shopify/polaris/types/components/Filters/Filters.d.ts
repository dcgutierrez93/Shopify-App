...
declare class FiltersInner extends React.Component<ComposedProps, State> {
    static contextType: React.Context<import("../../utilities/resource-list").ResourceListContextType>;
    state: State;
    private moreFiltersButtonContainer;
    private focusNode;
    render(): JSX.Element;
    private hasAppliedFilters;
...
export declare const Filters: React.FunctionComponent<FiltersProps> & import("hoist-non-react-statics").NonReactStatics<(React.ComponentClass<ComposedProps, any> & typeof FiltersInner) | (React.FunctionComponent<ComposedProps> & typeof FiltersInner), {}>;
export {};
