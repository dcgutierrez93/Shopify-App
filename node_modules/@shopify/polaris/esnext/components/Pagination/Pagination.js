...
export function Pagination({ hasNext, hasPrevious, nextURL, previousURL, onNext, onPrevious, nextTooltip, previousTooltip, nextKeys, previousKeys, plain, accessibilityLabel, label, }) {
    ...
    const previousClassName = classNames(styles.Button, unstableGlobalTheming && styles.globalTheming, !label && styles.PreviousButton);
    const nextClassName = classNames(styles.Button, unstableGlobalTheming && styles.globalTheming, unstableGlobalTheming && styles.rightButton, !label && styles.NextButton);
    ...
    const labelMarkup = label ? (<div className={styles.Label} aria-live="polite">
      {labelTextMarkup}
    </div>) : null;
    return (<nav className={className} aria-label={navLabel} ref={node}>
