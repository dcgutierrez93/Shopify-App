...
class BaseResourceItem extends React.Component {
    ...
    shouldComponentUpdate(nextProps, nextState) {
        const _a = nextProps.context, { selectedItems: nextSelectedItems } = _a, restNextContext = __rest(_a, ["selectedItems"]), restNextProps = __rest(nextProps, ["context"]);
        const _b = this.props, _c = _b.context, { selectedItems } = _c, restContext = __rest(_c, ["selectedItems"]), restProps = __rest(_b, ["context"]);
    ...
    render() {
        const { children, url, external, media, shortcutActions, ariaControls, ariaExpanded, persistActions = false, accessibilityLabel, name, context: { selectable, selectMode, loading, resourceName }, i18n, features: { unstableGlobalTheming }, } = this.props;
        ...
        const className = classNames(styles.ResourceItem, unstableGlobalTheming && styles.globalTheming, focused && styles.focused, selectable && styles.selectable, selected && styles.selected, selectMode && styles.selectMode, persistActions && styles.persistActions, focusedInner && styles.focusedInner);
