...
export const TopBar = function TopBar({ showNavigationToggle, userMenu, searchResults, searchField, secondaryMenu, searchResultsVisible, searchResultsOverlayVisible = false, onNavigationToggle, onSearchResultsDismiss, contextControl, }) {
    ...
    const scrollListenerMarkup = unstableGlobalTheming ? (<EventListener event="scroll" handler={handleScroll} passive/>) : null;
    const className = classNames(styles.TopBar, unstableGlobalTheming && styles['TopBar-globalTheming'], scrolled && styles.isScrolled);
