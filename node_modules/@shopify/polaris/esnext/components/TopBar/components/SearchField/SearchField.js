...
export function SearchField({ value, focused, active, placeholder, onChange, onFocus, onBlur, onCancel, }) {
    const i18n = useI18n();
    ...
    const className = classNames(styles.SearchField, (focused || active || forceActive) && styles.focused, unstableGlobalTheming && styles['SearchField-globalTheming']);
