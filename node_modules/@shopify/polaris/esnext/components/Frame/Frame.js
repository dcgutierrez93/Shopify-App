...
class FrameInner extends React.PureComponent {
    ...
    render() {
        ...
        const navClassName = classNames(styles.Navigation, showMobileNavigation && styles['Navigation-visible'], unstableGlobalTheming && styles['Navigation-globalTheming']);
        ...
        const contextualSaveBarMarkup = (<CSSAnimation in={showContextualSaveBar} className={styles.ContextualSaveBar} type="fade">
        <ContextualSaveBar {...this.contextualSaveBar}/>
      </CSSAnimation>);
        const topBarClassName = classNames(styles.TopBar, unstableGlobalTheming && styles['TopBar-globalTheming']);
        const topBarMarkup = topBar ? (<div className={topBarClassName} {...layer.props} {...dataPolarisTopBar.props} id={APP_FRAME_TOP_BAR}>
        {topBar}
      </div>) : null;
        const globalRibbonClassName = classNames(styles.GlobalRibbonContainer, unstableGlobalTheming && styles['GlobalRibbonContainer-globalTheming']);
        ...
        const mainClassName = classNames(styles.Main, unstableGlobalTheming && styles['Main-globalTheming']);
