...
export const Navigation = function Navigation({ children, contextControl, location, onDismiss, }) {
    ...
    const logoMarkup = logo && unstableGlobalTheming ? (<div className={styles.LogoContainer}>
    ...
    const className = classNames(styles.Navigation, !mediaMarkup && unstableGlobalTheming && styles['Navigation-noMedia'], unstableGlobalTheming && styles['Navigation-globalTheming']);
    const context = {
        location,
