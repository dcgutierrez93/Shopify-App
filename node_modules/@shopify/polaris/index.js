...
var colorFactory = require('@shopify/polaris-tokens/color-factory');
...
var DefaultThemeColors = _interopDefault(require('@shopify/polaris-tokens/dist/base.json'));
...
if (typeof window !== 'undefined') {
  ...
  window.Polaris.VERSION = '4.13.1';
}

var polarisVersion = '4.13.1';
...
function Avatar(_ref) {
  ...
  var imageMarkUp = source && !isServer && status !== Status.Errored ? React__default.createElement(Image, {
  ...
  var avatarBody = customer ? React__default.createElement("g", {
    fill: "currentColor",
    fillRule: "nonzero"
  ...
  var svgMarkup = !hasImage ? React__default.createElement("span", {
...
function buildCustomProperties(themeConfig, globalTheming, tokens) {
  ...
  return globalTheming ? customPropertyTransformer(Object.assign(Object.assign({}, colorFactory.colorFactory(UNSTABLE_colors, colorScheme)), tokens)) : buildLegacyColors(themeConfig);
}
...
var Popover = function Popover(_a) {
  var _a$activatorWrapper = _a.activatorWrapper,
      ...
      rest = tslib.__rest(_a, ["activatorWrapper", "children", "onClose", "activator", "active", "fixed", "ariaHaspopup"]);
...
function ActionList(_ref) {
  ...
  var sectionMarkup = finalSections.map(function (section, index) {
    return section.items.length > 0 ? React__default.createElement(Section$1, {
...
function Button(_ref) {
  ...
  if (connectedDisclosure) {
    var connectedDisclosureClassName = classNames(styles$a.Button, primary && styles$a.primary, outline && styles$a.outline, size && size !== DEFAULT_SIZE$1 && styles$a[variationName('size', size)], textAlign && styles$a[variationName('textAlign', textAlign)], destructive && styles$a.destructive, connectedDisclosure.disabled && styles$a.disabled, styles$a.iconOnly, styles$a.ConnectedDisclosure, unstableGlobalTheming && styles$a.globalTheming);
    ...
    var connectedDisclosureActivator = React__default.createElement("button", {
      type: "button",
    ...
    connectedDisclosureMarkup = React__default.createElement(Popover, {
  ...
  if (url) {
    buttonMarkup = isDisabled ? // Render an `<a>` so toggling disabled/enabled state changes only the
    ...
    buttonMarkup = React__default.createElement("button", {
      id: id,
      type: type,
      onClick: onClick,
      onFocus: onFocus,
  ...
  return connectedDisclosureMarkup ? React__default.createElement("div", {
...
var styles$i = {
  ...
  "globalTheming": "Polaris-ActionMenu-MenuAction--globalTheming",
...
function MenuAction(_ref) {
  ...
  var _useFeatures = useFeatures(),
      unstableGlobalTheming = _useFeatures.unstableGlobalTheming;
  ...
  var menuActionClassNames = classNames(styles$i.MenuAction, unstableGlobalTheming && styles$i.globalTheming, disabled && styles$i.disabled);
    ...
    _this.renderActions = function () {
      ...
      var actionMarkup = overriddenActions.map(function (action, index) {
        if ('title' in action) {
          ...
          return _actions.length > 0 ? React__default.createElement(MenuGroup, Object.assign({
...
function ThemeProvider(_ref) {
  ...
  var UNSTABLE_colors = themeConfig.UNSTABLE_colors,
      colorScheme = themeConfig.colorScheme,
      rest = tslib.__rest(themeConfig, ["UNSTABLE_colors", "colorScheme"]);
...
function TextField(_ref) {
  ...
  var _useFeatures = useFeatures(),
      _useFeatures$unstable = _useFeatures.unstableGlobalTheming,
      unstableGlobalTheming = _useFeatures$unstable === void 0 ? false : _useFeatures$unstable; // Use a typeof check here as Typescript mostly protects us from non-stringy
  ...
  if (showCharacterCount) {
    ...
    characterCountMarkup = React__default.createElement("div", {
...
function (_React$PureComponent) {
  ...
  _createClass(Banner, [{
    ...
    value: function render() {
      ...
      var handleMouseUp = function handleMouseUp(_ref) {
        var currentTarget = _ref.currentTarget;
      ...
      return React__default.createElement(BannerContext.Provider, {
        ...
        var className = classNames(styles$x.Banner, status && styles$x[variationName('status', status)], onDismiss && styles$x.hasDismiss, showFocus && styles$x.keyFocused, withinContentContainer ? styles$x.withinContentContainer : styles$x.withinPage);
        var id = uniqueID();
...
var styles$D = {
  ...
  "globalTheming": "Polaris-Checkbox--globalTheming",
...
var Checkbox$1 = React__default.forwardRef(function Checkbox(_ref, ref) {
  ...
  var wrapperClassName = classNames(styles$D.Checkbox, error && styles$D.error, unstableGlobalTheming && styles$D.globalTheming);
  ...
  var inputClassName = classNames(styles$D.Input, isIndeterminate && styles$D['Input-indeterminate'], unstableGlobalTheming && keyFocused && styles$D.keyFocused);
  return (
...
var styles$E = {
  ...
  "globalTheming": "Polaris-RadioButton--globalTheming",
...
function RadioButton(_ref) {
  ...
  var ariaDescribedBy = describedBy.length ? describedBy.join(' ') : undefined;
  var inputClassName = classNames(styles$E.Input, unstableGlobalTheming && keyFocused && styles$E.keyFocused);
  var wrapperClassName = classNames(styles$E.RadioButton, unstableGlobalTheming && styles$E.globalTheming);
  var iconMarkup = !unstableGlobalTheming && React__default.createElement("span", {
...
function (_React$Component) {
  ...
  function CollapsibleInner() {
    ...
    _this = _possibleConstructorReturn(this, _getPrototypeOf(CollapsibleInner).apply(this, arguments));
    _this.state = {
      height: null,
      animationState: 'idle',
...
function (_React$PureComponent) {
  ...
  function DataTableInner() {
    ...
    _this = _possibleConstructorReturn(this, _getPrototypeOf(DataTableInner).apply(this, arguments));
    _this.state = {
      condensed: false,
  ...
  _createClass(DataTableInner, [{
    ...
    value: function render() {
      ...
      var navigationMarkup = hideScrollIndicator ? null : React__default.createElement(Navigation, {
...
function FileUpload(props) {
  ...
  var buttonStyles = size === 'extraLarge' || size === 'large' ? classNames(styles$M.Button, unstableGlobalTheming && styles$M.globalTheming, size && size !== 'extraLarge' && styles$M.slim, focused && styles$M.focused, disabled && styles$M.disabled) : null;
  ...
  var fileUploadClassName = classNames(styles$M.FileUpload, unstableGlobalTheming && styles$M.globalTheming, measuring && styles$M.measuring);
  return React__default.createElement("div", {
...
var styles$N = {
  ...
  "globalTheming": "Polaris-DropZone--globalTheming",
...
var DropZone = function DropZone(_ref) {
  ...
  var _useState7 = React.useState('extraLarge'),
  ...
  var classes = classNames(styles$N.DropZone, outline && styles$N.hasOutline, focused && styles$N.focused, (active || dragging) && styles$N.isDragging, disabled && styles$N.isDisabled, unstableGlobalTheming && styles$N.globalTheming, (internalError || error) && styles$N.hasError, styles$N[variationName('size', size)], measuring && styles$N.measuring);
  ...
  function overlayMarkup(icon, color, text) {
    var overlayClass = classNames(styles$N.Overlay, unstableGlobalTheming && styles$N.globalTheming);
    return React__default.createElement("div", {
...
var styles$S = {
  ...
  "globalTheming": "Polaris-Tag--globalTheming"
};
...
function Tag(_ref) {
  ...
  var buttonClassName = classNames(styles$S.Button, unstableGlobalTheming && styles$S.globalTheming);
  return React__default.createElement("span", {
    className: className
  }, React__default.createElement("span", {
    title: children,
...
function TrapFocus(_ref) {
  ...
  React.useEffect(function () {
    setFocusSelf(!(focusTrapWrapper.current && focusTrapWrapper.current.contains(document.activeElement)));
  }, []);
  ...
  var handleFocusIn = function handleFocusIn(event) {
    ...
    if (focusTrapWrapper.current !== event.target && !focusTrapWrapper.current.contains(event.target)) {
...
function (_React$Component) {
  ...
  function FiltersInner() {
    ...
    _this = _possibleConstructorReturn(this, _getPrototypeOf(FiltersInner).apply(this, arguments));
    _this.state = {
      open: false,
      readyForFocus: false
    };
  ...
  _createClass(FiltersInner, [{
    ...
    value: function render() {
      ...
      var filtersDesktopHeaderMarkup = React__default.createElement("div", {
        ...
        size: "small"
      }, moreFiltersLabel), React__default.createElement(Button, {
        icon: polarisIcons.CancelSmallMinor,
        plain: true,
      ...
      var tagsMarkup = !hideTags && appliedFilters && appliedFilters.length ? React__default.createElement("div", {
...
var Filters = withAppProvider()(FiltersInner);
...
function (_React$Component) {
  ...
  function ModalInner() {
    ...
    _this = _possibleConstructorReturn(this, _getPrototypeOf(ModalInner).apply(this, arguments));
    ...
    _this.handleExited = function () {
      ...
      if (_this.focusReturnPointNode) {
        fastdom.write(function () {
          return _this.focusReturnPointNode && focus.focusFirstFocusableNode(_this.focusReturnPointNode, false);
        });
      }
    };
...
var styles$17 = {
  ...
  "Navigation-globalTheming": "Polaris-Frame__Navigation--globalTheming",
  ...
  "TopBar-globalTheming": "Polaris-Frame__TopBar--globalTheming",
  ...
  "Main-globalTheming": "Polaris-Frame__Main--globalTheming",
  "Content": "Polaris-Frame__Content",
  "GlobalRibbonContainer": "Polaris-Frame__GlobalRibbonContainer",
  "GlobalRibbonContainer-globalTheming": "Polaris-Frame__GlobalRibbonContainer--globalTheming",
...
function (_React$PureComponent) {
  ...
  function FrameInner() {
    ...
    _this = _possibleConstructorReturn(this, _getPrototypeOf(FrameInner).apply(this, arguments));
    _this.state = {
      skipFocused: false,
  ...
  _createClass(FrameInner, [{
    ...
    value: function render() {
      ...
      var _ref8 = this.context || {},
          unstableGlobalTheming = _ref8.unstableGlobalTheming;

      var navClassName = classNames(styles$17.Navigation, showMobileNavigation && styles$17['Navigation-visible'], unstableGlobalTheming && styles$17['Navigation-globalTheming']);
      ...
      var topBarClassName = classNames(styles$17.TopBar, unstableGlobalTheming && styles$17['TopBar-globalTheming']);
      var topBarMarkup = topBar ? React__default.createElement("div", Object.assign({
        className: topBarClassName
      }, layer.props, dataPolarisTopBar.props, {
        id: APP_FRAME_TOP_BAR
      }), topBar) : null;
      var globalRibbonClassName = classNames(styles$17.GlobalRibbonContainer, unstableGlobalTheming && styles$17['GlobalRibbonContainer-globalTheming']);
      ...
      var mainClassName = classNames(styles$17.Main, unstableGlobalTheming && styles$17['Main-globalTheming']);
...
var styles$1d = {
  ...
  "Navigation-globalTheming": "Polaris-Navigation__Navigation--globalTheming",
...
var Navigation$1 = function Navigation(_ref) {
  ...
  var width = getWidth(logo, 104);
  var logoMarkup = logo && unstableGlobalTheming ? React__default.createElement("div", {
  ...
  var mediaMarkup = contextControl ? React__default.createElement("div", {
    className: styles$1d.ContextControl
  }, contextControl) : logoMarkup;
  var className = classNames(styles$1d.Navigation, !mediaMarkup && unstableGlobalTheming && styles$1d['Navigation-noMedia'], unstableGlobalTheming && styles$1d['Navigation-globalTheming']);
  var context = {
    location,
  ...
  return React__default.createElement(NavigationContext.Provider, {
    ...
    className: className
  }, mediaMarkup, React__default.createElement(Scrollable, {
...
function Pagination(_ref) {
  ...
  var previousClassName = classNames(styles$1f.Button, unstableGlobalTheming && styles$1f.globalTheming, !label && styles$1f.PreviousButton);
  var nextClassName = classNames(styles$1f.Button, unstableGlobalTheming && styles$1f.globalTheming, unstableGlobalTheming && styles$1f.rightButton, !label && styles$1f.NextButton);
...
var styles$1n = {
  ...
  "globalTheming": "Polaris-ResourceItem--globalTheming",
  ...
  _createClass(BaseResourceItem, [{
    ...
    value: function render() {
      var _this$props4 = this.props,
          ...
          unstableGlobalTheming = _this$props4.features.unstableGlobalTheming;
      var _this$state = this.state,
      ...
      var className = classNames(styles$1n.ResourceItem, unstableGlobalTheming && styles$1n.globalTheming, focused && styles$1n.focused, selectable && styles$1n.selectable, selected && styles$1n.selected, selectMode && styles$1n.selectMode, persistActions && styles$1n.persistActions, focusedInner && styles$1n.focusedInner);
...
function (_React$Component) {
  ...
  function StickyInner() {
    ...
    _this = _possibleConstructorReturn(this, _getPrototypeOf(StickyInner).apply(this, arguments));
    _this.state = {
      isSticky: false,
      style: {}
    };
...
function (_React$PureComponent) {
  ...
  function BulkActionsInner() {
    ...
    _this = _possibleConstructorReturn(this, _getPrototypeOf(BulkActionsInner).apply(this, arguments));
    _this.state = {
...
function (_React$Component) {
  ...
  function ResourceListInner(props) {
    ...
    _this = _possibleConstructorReturn(this, _getPrototypeOf(ResourceListInner).call(this, props));
  ...
  _createClass(ResourceListInner, [{
    ...
    value: function render() {
      ...
      }, React__default.createElement(BulkActions, {
      ...
      }, React__default.createElement(Sticky, {
...
function (_React$PureComponent) {
  ...
  function ResourcePickerInner() {
    ...
    _this = _possibleConstructorReturn(this, _getPrototypeOf(ResourcePickerInner).apply(this, arguments));
...
function (_React$PureComponent) {
  ...
  function TabsInner() {
    ...
    _this = _possibleConstructorReturn(this, _getPrototypeOf(TabsInner).apply(this, arguments));
    _this.state = {
      disclosureWidth: 0,
...
function SearchDismissOverlay(_ref) {
  ...
  return React__default.createElement(React__default.Fragment, null, visible ? React__default.createElement(ScrollLock, null) : null, React__default.createElement("div", {
    ref: node,
...
function Search(_ref) {
  ...
  var overlayMarkup = visible ? React__default.createElement(SearchDismissOverlay, {
    onDismiss: onDismiss,
    visible: overlayVisible
  }) : null;
  return React__default.createElement("div", {
    className: classNames(styles$1B.Search, visible && styles$1B.visible)
  }, overlayMarkup, React__default.createElement("div", {
...
var styles$1C = {
  ...
  "SearchField-globalTheming": "Polaris-TopBar-SearchField__SearchField--globalTheming",
...
function SearchField(_ref) {
  ...
  var className = classNames(styles$1C.SearchField, (focused || active || forceActive) && styles$1C.focused, unstableGlobalTheming && styles$1C['SearchField-globalTheming']);
  return React__default.createElement("div", {
    className: className,
    onFocus: handleFocus,
    onBlur: handleBlur
...
var styles$1H = {
  ...
  "TopBar-globalTheming": "Polaris-TopBar__TopBar--globalTheming",
...
var TopBar = function TopBar(_ref) {
  ...
  var searchMarkup = searchField ? React__default.createElement(React__default.Fragment, null, searchField, React__default.createElement(Search, {
    visible: searchResultsVisible,
    onDismiss: onSearchResultsDismiss,
    overlayVisible: searchResultsOverlayVisible
  }, searchResults)) : null;
  var scrollListenerMarkup = unstableGlobalTheming ? React__default.createElement(EventListener, {
    event: "scroll",
    handler: handleScroll,
    passive: true
  }) : null;
  var className = classNames(styles$1H.TopBar, unstableGlobalTheming && styles$1H['TopBar-globalTheming'], scrolled && styles$1H.isScrolled);
  return React__default.createElement("div", {
    className: className
